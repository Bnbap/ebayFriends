...
@SuppressLint("NewApi")
public class ProfileAdapter extends ArrayAdapter<NewsFeedItem> {
	...
	public ProfileAdapter(Activity activity,
		  ImageLoader imageLoader, final ListView lv) {
		super(activity, R.layout.newsfeeditem);
		this.newsFeedList = new ArrayList<NewsFeedItem>();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		Log.e("Profile", "getview position:" + position);

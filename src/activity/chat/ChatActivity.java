...
public class ChatActivity extends Activity implements OnClickListener {
	...
	public void initView() {
		...
		otherNameText = (TextView) findViewById(R.id.otherName);
	...
	public void initData() {
		if (receivedMsg != null) {
			...
			entity.setName(receivedMsg.split(" ")[0]);
			entity.setMsgType(true);

			entity.setText(receivedMsg.split(" ")[1]);
	...
	protected void onDestroy() {
		...
		super.onDestroy();
		disConnect();
		startService(ChatService.getIntent()); // System.exit(0);
	}
	...
	protected void onStop() {
		...
		super.onStop();
		disConnect();
		startService(ChatService.getIntent());
	}
